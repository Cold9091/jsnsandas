      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center px-6 py-3 bg-blue-100/80 dark:bg-blue-900/50 text-blue-800 dark:text-blue-200 rounded-full text-sm font-medium mb-12 backdrop-blur-sm border border-blue-200/50 dark:border-blue-700/50 shadow-lg"
            whileHover={{ 
              scale: 1.05, 
